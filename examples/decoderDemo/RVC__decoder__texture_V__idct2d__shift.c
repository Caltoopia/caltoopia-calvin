...
typedef struct {
  ...
  int _fsmState;
} ActorInstance_RVC_decoder__texture_V__idct2d__shift;

//Actor functions
ART_ACTION_CONTEXT(1, 1)

ART_ACTION(action0, ActorInstance_RVC_decoder__texture_V__idct2d__shift);
ART_ACTION_SCHEDULER(RVC_decoder__texture_V__idct2d__shift_action_scheduler);
static void ActorInstance_RVC_decoder__texture_V__idct2d__shift_constructor(AbstractActorInstance *);
...
ActorClass klass=INIT_ActorClass(
  "RVC_decoder__texture_V__idct2d__shift",
  ActorInstance_RVC_decoder__texture_V__idct2d__shift,
  ActorInstance_RVC_decoder__texture_V__idct2d__shift_constructor,
  0, //setParam not needed anymore (we instantiate with params)
  0, 0, // serialize/deserialize
  RVC_decoder__texture_V__idct2d__shift_action_scheduler,
  0, // no destructor
...
#define ActorInstance_RVC_decoder__texture_V__idct2d__shift__defaultState_ID 0
static void ActorInstance_RVC_decoder__texture_V__idct2d__shift_constructor(AbstractActorInstance *pBase) {
  ActorInstance_RVC_decoder__texture_V__idct2d__shift *thisActor=(ActorInstance_RVC_decoder__texture_V__idct2d__shift*) pBase;
  thisActor->_fsmState = ActorInstance_RVC_decoder__texture_V__idct2d__shift__defaultState_ID;//Initial state
  {
  }
...
ART_ACTION_SCHEDULER(RVC_decoder__texture_V__idct2d__shift_action_scheduler) {
  ...
  while(1) {
    ...
    switch(thisActor->_fsmState) {
      case ActorInstance_RVC_decoder__texture_V__idct2d__shift__defaultState_ID:
        result = exitcode_block_Any;
        goto out;
        break;
