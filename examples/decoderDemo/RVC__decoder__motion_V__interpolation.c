...
//Actor functions
inline int32_t RVC_decoder__motion_V__interpolationcompensate(ActorInstance_RVC_decoder__motion_V__interpolation* thisActor, int32_t p00, int32_t p10, int32_t p01, int32_t p11){
