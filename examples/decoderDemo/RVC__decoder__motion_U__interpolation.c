...
ART_ACTION(action0__start, ActorInstance_RVC_decoder__motion_U__interpolation);
ART_ACTION(action1__done, ActorInstance_RVC_decoder__motion_U__interpolation);
ART_ACTION(action2__row_col_0, ActorInstance_RVC_decoder__motion_U__interpolation);
ART_ACTION(action3__other, ActorInstance_RVC_decoder__motion_U__interpolation);
ART_ACTION_SCHEDULER(RVC_decoder__motion_U__interpolation_action_scheduler);
static void ActorInstance_RVC_decoder__motion_U__interpolation_constructor(AbstractActorInstance *);
...
ActorClass klass=INIT_ActorClass(
  "RVC_decoder__motion_U__interpolation",
  ActorInstance_RVC_decoder__motion_U__interpolation,
  ActorInstance_RVC_decoder__motion_U__interpolation_constructor,
  0, //setParam not needed anymore (we instantiate with params)
  RVC_decoder__motion_U__interpolation_action_scheduler,
  0, // no destructor
...
bool_t RVC_decoder__motion_U__interpolation__DOLLAR__d1756(art_action_context_t *context, ActorInstance_RVC_decoder__motion_U__interpolation *thisActor) {
  {
    bool_t ret;
    ret = (thisActor->y == 9);
    return ret;
...
bool_t RVC_decoder__motion_U__interpolation__DOLLAR__d1763(art_action_context_t *context, ActorInstance_RVC_decoder__motion_U__interpolation *thisActor) {
  {
    bool_t ret;
...
bool_t RVC_decoder__motion_U__interpolation__DOLLAR__d1796(art_action_context_t *context, ActorInstance_RVC_decoder__motion_U__interpolation *thisActor) {
  {
    bool_t ret;
    ret = (thisActor->x != 0);
    return ret;
...
bool_t RVC_decoder__motion_U__interpolation__DOLLAR__d1800(art_action_context_t *context, ActorInstance_RVC_decoder__motion_U__interpolation *thisActor) {
  {
    bool_t ret;
    ret = (thisActor->y != 0);
    return ret;
...
bool_t RVC_decoder__motion_U__interpolation__DOLLAR__d1804(art_action_context_t *context, ActorInstance_RVC_decoder__motion_U__interpolation *thisActor) {
  {
    bool_t ret;
    ret = (thisActor->y != 9);
    return ret;
...
ART_ACTION(action3__other, ActorInstance_RVC_decoder__motion_U__interpolation) {
  ...
  d = pinRead_int32_t(IN0_RD);
  p = RVC_decoder__motion_U__interpolationcompensate(thisActor, thisActor->d9, thisActor->d8, thisActor->d0, d);
  thisActor->d9 = thisActor->d8;
  thisActor->d8 = thisActor->d7;
  thisActor->d7 = thisActor->d6;
  thisActor->d6 = thisActor->d5;
...
#define ActorInstance_RVC_decoder__motion_U__interpolation__start_ID 0
#define ActorInstance_RVC_decoder__motion_U__interpolation__interpolate_ID 1
static void ActorInstance_RVC_decoder__motion_U__interpolation_constructor(AbstractActorInstance *pBase) {
  ActorInstance_RVC_decoder__motion_U__interpolation *thisActor=(ActorInstance_RVC_decoder__motion_U__interpolation*) pBase;
  thisActor->_fsmState = ActorInstance_RVC_decoder__motion_U__interpolation__start_ID;//Initial state
  {
  }
...
ART_ACTION_SCHEDULER(RVC_decoder__motion_U__interpolation_action_scheduler) {
  ...
  while(1) {
    switch(thisActor->_fsmState) {
      case ActorInstance_RVC_decoder__motion_U__interpolation__start_ID:
        if ((pinAvailIn_int32_t(IN1_halfpel) >= 1)) {
          ART_FIRE_ACTION(action0__start);
          thisActor->_fsmState = ActorInstance_RVC_decoder__motion_U__interpolation__interpolate_ID;
          continue;
        }
      ...
      case ActorInstance_RVC_decoder__motion_U__interpolation__interpolate_ID:
        if (RVC_decoder__motion_U__interpolation__DOLLAR__d1756(context, thisActor)) {
          ART_FIRE_ACTION(action1__done);
          thisActor->_fsmState = ActorInstance_RVC_decoder__motion_U__interpolation__start_ID;
          continue;
        }
        if ((pinAvailIn_int32_t(IN0_RD) >= 1)) {
          if (RVC_decoder__motion_U__interpolation__DOLLAR__d1763(context, thisActor)) {
        ...
        if ((pinAvailIn_int32_t(IN0_RD) >= 1)) {
          if (RVC_decoder__motion_U__interpolation__DOLLAR__d1796(context, thisActor) && RVC_decoder__motion_U__interpolation__DOLLAR__d1800(context, thisActor) && RVC_decoder__motion_U__interpolation__DOLLAR__d1804(context, thisActor)) {
