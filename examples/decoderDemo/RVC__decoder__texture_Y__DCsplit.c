...
typedef struct {
  ...
  int _fsmState;
} ActorInstance_RVC_decoder__texture_Y__DCsplit;

//Actor functions
ART_ACTION_CONTEXT(1, 2)

ART_ACTION(action0, ActorInstance_RVC_decoder__texture_Y__DCsplit);
ART_ACTION_SCHEDULER(RVC_decoder__texture_Y__DCsplit_action_scheduler);
static void ActorInstance_RVC_decoder__texture_Y__DCsplit_constructor(AbstractActorInstance *);
...
ActorClass klass=INIT_ActorClass(
  "RVC_decoder__texture_Y__DCsplit",
  ActorInstance_RVC_decoder__texture_Y__DCsplit,
  ActorInstance_RVC_decoder__texture_Y__DCsplit_constructor,
  0, //setParam not needed anymore (we instantiate with params)
  RVC_decoder__texture_Y__DCsplit_action_scheduler,
  0, // no destructor
...
#define ActorInstance_RVC_decoder__texture_Y__DCsplit__defaultState_ID 0
static void ActorInstance_RVC_decoder__texture_Y__DCsplit_constructor(AbstractActorInstance *pBase) {
  ActorInstance_RVC_decoder__texture_Y__DCsplit *thisActor=(ActorInstance_RVC_decoder__texture_Y__DCsplit*) pBase;
  thisActor->_fsmState = ActorInstance_RVC_decoder__texture_Y__DCsplit__defaultState_ID;//Initial state
  {
  }
...
ART_ACTION_SCHEDULER(RVC_decoder__texture_Y__DCsplit_action_scheduler) {
  ...
  while(1) {
    ...
    switch(thisActor->_fsmState) {
      case ActorInstance_RVC_decoder__texture_Y__DCsplit__defaultState_ID:
        result = exitcode_block_Any;
        goto out;
        break;
