...
//Actor functions
inline int32_t RVC_decoder__texture_V__DCRecontruction__invpredabs(ActorInstance_RVC_decoder__texture_V__DCRecontruction__invpred* thisActor, int32_t x){
  return (((x < 0)) ? ((-(x))):(x));
}
inline int32_t RVC_decoder__texture_V__DCRecontruction__invpreddc_scaler(ActorInstance_RVC_decoder__texture_V__DCRecontruction__invpred* thisActor){
...
inline int32_t RVC_decoder__texture_V__DCRecontruction__invpredsaturate(ActorInstance_RVC_decoder__texture_V__DCRecontruction__invpred* thisActor, int32_t x){
  bool_t minus;
  bool_t plus;
  int32_t ret;
  minus = (x < (-(2048)));
