...
ART_ACTION(action0, ActorInstance_RVC_decoder__texture_V__idct2d__column);
ART_ACTION_SCHEDULER(RVC_decoder__texture_V__idct2d__column_action_scheduler);
static void ActorInstance_RVC_decoder__texture_V__idct2d__column_constructor(AbstractActorInstance *);
...
ART_ACTION(action0, ActorInstance_RVC_decoder__texture_V__idct2d__column) {
  ...
  x[7] = (xb + x[5]);
  x[5] = (xb - x[5]);
  temp1 = RVC_decoder__texture_V__idct2d__columnpmul_1_0(thisActor, x[3]);
  temp4 = RVC_decoder__texture_V__idct2d__columnpmul_1_1(thisActor, x[3]);
  temp3 = RVC_decoder__texture_V__idct2d__columnpmul_1_0(thisActor, x[5]);
  temp2 = RVC_decoder__texture_V__idct2d__columnpmul_1_1(thisActor, x[5]);
  x[3] = (temp1 - temp2);
  x[5] = (temp3 + temp4);
  temp1 = RVC_decoder__texture_V__idct2d__columnpmul_2_0(thisActor, x[1]);
  temp4 = RVC_decoder__texture_V__idct2d__columnpmul_2_1(thisActor, x[1]);
  temp3 = RVC_decoder__texture_V__idct2d__columnpmul_2_0(thisActor, x[7]);
  temp2 = RVC_decoder__texture_V__idct2d__columnpmul_2_1(thisActor, x[7]);
  x[1] = (temp1 + temp2);
  x[7] = (temp3 - temp4);
  temp1 = RVC_decoder__texture_V__idct2d__columnpmul_3_0(thisActor, x[2]);
  temp4 = RVC_decoder__texture_V__idct2d__columnpmul_3_1(thisActor, x[2]);
  temp3 = RVC_decoder__texture_V__idct2d__columnpmul_3_0(thisActor, x[6]);
  temp2 = RVC_decoder__texture_V__idct2d__columnpmul_3_1(thisActor, x[6]);
  x[2] = (temp1 - temp2);
  x[6] = (temp3 + temp4);
  xa = (x[0] + x[4]);
  xb = (x[0] - x[4]);
...
#define ActorInstance_RVC_decoder__texture_V__idct2d__column__defaultState_ID 0
static void ActorInstance_RVC_decoder__texture_V__idct2d__column_constructor(AbstractActorInstance *pBase) {
  ActorInstance_RVC_decoder__texture_V__idct2d__column *thisActor=(ActorInstance_RVC_decoder__texture_V__idct2d__column*) pBase;
  thisActor->_fsmState = ActorInstance_RVC_decoder__texture_V__idct2d__column__defaultState_ID;//Initial state
  {
  }
...
ART_ACTION_SCHEDULER(RVC_decoder__texture_V__idct2d__column_action_scheduler) {
  ...
  while(1) {
    ...
    switch(thisActor->_fsmState) {
      case ActorInstance_RVC_decoder__texture_V__idct2d__column__defaultState_ID:
        result = exitcode_block_Any;
        goto out;
        break;
