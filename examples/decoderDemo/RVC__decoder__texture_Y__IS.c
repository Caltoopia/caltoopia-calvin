...
typedef struct {
  ...
  int32_t count;
  int32_t* buf;
} ActorInstance_RVC_decoder__texture_Y__IS;

//Actor functions
inline int32_t RVC_decoder__texture_Y__ISwa(ActorInstance_RVC_decoder__texture_Y__IS* thisActor){
  return bitor(bitand(thisActor->count, 63), ((thisActor->half) ? (64):(0)));
}
inline int32_t RVC_decoder__texture_Y__ISra(ActorInstance_RVC_decoder__texture_Y__IS* thisActor, int32_t address){
  return bitor(bitand(address, 63), ((thisActor->half) ? (0):(64)));
}
ART_ACTION_CONTEXT(2, 1)

ART_ACTION(action0__skip, ActorInstance_RVC_decoder__texture_Y__IS);
ART_ACTION(action1__start, ActorInstance_RVC_decoder__texture_Y__IS);
ART_ACTION(action2__done, ActorInstance_RVC_decoder__texture_Y__IS);
ART_ACTION(action3__read_only, ActorInstance_RVC_decoder__texture_Y__IS);
ART_ACTION(action4__write_only, ActorInstance_RVC_decoder__texture_Y__IS);
ART_ACTION(action5__read_write, ActorInstance_RVC_decoder__texture_Y__IS);
ART_ACTION_SCHEDULER(RVC_decoder__texture_Y__IS_action_scheduler);
static void ActorInstance_RVC_decoder__texture_Y__IS_constructor(AbstractActorInstance *);
...
ActorClass klass=INIT_ActorClass(
  "RVC_decoder__texture_Y__IS",
  ActorInstance_RVC_decoder__texture_Y__IS,
  ActorInstance_RVC_decoder__texture_Y__IS_constructor,
  0, //setParam not needed anymore (we instantiate with params)
  RVC_decoder__texture_Y__IS_action_scheduler,
  0, // no destructor
...
bool_t RVC_decoder__texture_Y__IS__DOLLAR__d7125(art_action_context_t *context, ActorInstance_RVC_decoder__texture_Y__IS *thisActor) {
  int32_t i;
  {
    bool_t ret;
...
bool_t RVC_decoder__texture_Y__IS__DOLLAR__d7134(art_action_context_t *context, ActorInstance_RVC_decoder__texture_Y__IS *thisActor) {
  int32_t i;
  {
    bool_t ret;
    i = pinPeek_int32_t(IN0_AC_PRED_DIR, 0);
...
bool_t RVC_decoder__texture_Y__IS__DOLLAR__d7141(art_action_context_t *context, ActorInstance_RVC_decoder__texture_Y__IS *thisActor) {
  {
    bool_t ret;
...
bool_t RVC_decoder__texture_Y__IS__DOLLAR__d7162(art_action_context_t *context, ActorInstance_RVC_decoder__texture_Y__IS *thisActor) {
  {
    bool_t ret;
    ret = (thisActor->count < 64);
    return ret;
...
bool_t RVC_decoder__texture_Y__IS__DOLLAR__d7172(art_action_context_t *context, ActorInstance_RVC_decoder__texture_Y__IS *thisActor) {
  {
    bool_t ret;
    ret = (thisActor->count < 64);
    return ret;
...
bool_t RVC_decoder__texture_Y__IS__DOLLAR__d7192(art_action_context_t *context, ActorInstance_RVC_decoder__texture_Y__IS *thisActor) {
  {
    bool_t ret;
    ret = (thisActor->count < 64);
    return ret;
...
#define ActorInstance_RVC_decoder__texture_Y__IS__rest_ID 0
#define ActorInstance_RVC_decoder__texture_Y__IS__read_ID 1
#define ActorInstance_RVC_decoder__texture_Y__IS__full_ID 2
#define ActorInstance_RVC_decoder__texture_Y__IS__write_ID 3
#define ActorInstance_RVC_decoder__texture_Y__IS__both_ID 4
static void ActorInstance_RVC_decoder__texture_Y__IS_constructor(AbstractActorInstance *pBase) {
  ActorInstance_RVC_decoder__texture_Y__IS *thisActor=(ActorInstance_RVC_decoder__texture_Y__IS*) pBase;
  thisActor->_fsmState = ActorInstance_RVC_decoder__texture_Y__IS__rest_ID;//Initial state
  {
...
ART_ACTION_SCHEDULER(RVC_decoder__texture_Y__IS_action_scheduler) {
  ...
  while(1) {
    switch(thisActor->_fsmState) {
      case ActorInstance_RVC_decoder__texture_Y__IS__rest_ID:
        if ((pinAvailIn_int32_t(IN0_AC_PRED_DIR) >= 1)) {
          if (RVC_decoder__texture_Y__IS__DOLLAR__d7125(context, thisActor)) {
            ART_FIRE_ACTION(action0__skip);
            thisActor->_fsmState = ActorInstance_RVC_decoder__texture_Y__IS__rest_ID;
            continue;
          }
        }
        if ((pinAvailIn_int32_t(IN0_AC_PRED_DIR) >= 1)) {
          if (RVC_decoder__texture_Y__IS__DOLLAR__d7134(context, thisActor)) {
            ART_FIRE_ACTION(action1__start);
            thisActor->_fsmState = ActorInstance_RVC_decoder__texture_Y__IS__read_ID;
            continue;
          }
        }
      ...
      case ActorInstance_RVC_decoder__texture_Y__IS__read_ID:
        if (RVC_decoder__texture_Y__IS__DOLLAR__d7141(context, thisActor)) {
          ART_FIRE_ACTION(action2__done);
          thisActor->_fsmState = ActorInstance_RVC_decoder__texture_Y__IS__full_ID;
          continue;
        }
        if ((pinAvailIn_int32_t(IN1_QFS_AC) >= 1)) {
          if (RVC_decoder__texture_Y__IS__DOLLAR__d7162(context, thisActor)) {
      ...
      case ActorInstance_RVC_decoder__texture_Y__IS__full_ID:
        if ((pinAvailIn_int32_t(IN0_AC_PRED_DIR) >= 1)) {
          if (RVC_decoder__texture_Y__IS__DOLLAR__d7125(context, thisActor)) {
            ART_FIRE_ACTION(action0__skip);
            thisActor->_fsmState = ActorInstance_RVC_decoder__texture_Y__IS__write_ID;
            continue;
          }
        }
        if ((pinAvailIn_int32_t(IN0_AC_PRED_DIR) >= 1)) {
          if (RVC_decoder__texture_Y__IS__DOLLAR__d7134(context, thisActor)) {
            ART_FIRE_ACTION(action1__start);
            thisActor->_fsmState = ActorInstance_RVC_decoder__texture_Y__IS__both_ID;
            continue;
          }
        }
        result = exitcode_block_Any;
      ...
      case ActorInstance_RVC_decoder__texture_Y__IS__write_ID:
        if (RVC_decoder__texture_Y__IS__DOLLAR__d7141(context, thisActor)) {
          ART_FIRE_ACTION(action2__done);
          thisActor->_fsmState = ActorInstance_RVC_decoder__texture_Y__IS__rest_ID;
          continue;
        }
        if (RVC_decoder__texture_Y__IS__DOLLAR__d7172(context, thisActor)) {
      ...
      case ActorInstance_RVC_decoder__texture_Y__IS__both_ID:
        if (RVC_decoder__texture_Y__IS__DOLLAR__d7141(context, thisActor)) {
          ART_FIRE_ACTION(action2__done);
          thisActor->_fsmState = ActorInstance_RVC_decoder__texture_Y__IS__full_ID;
          continue;
        ...
        if ((pinAvailIn_int32_t(IN1_QFS_AC) >= 1)) {
          if (RVC_decoder__texture_Y__IS__DOLLAR__d7192(context, thisActor)) {
            if ((pinAvailOut_int32_t(OUT0_PQF_AC) >= 1)) {
