...
typedef struct {
  ...
  int _fsmState;
  bool_t sflag;
} ActorInstance_RVC_decoder__texture_V__idct2d__clip;

//Actor functions
ART_ACTION_CONTEXT(2, 1)

ART_ACTION(action0__read_signed, ActorInstance_RVC_decoder__texture_V__idct2d__clip);
ART_ACTION(action1__clip, ActorInstance_RVC_decoder__texture_V__idct2d__clip);
ART_ACTION_SCHEDULER(RVC_decoder__texture_V__idct2d__clip_action_scheduler);
static void ActorInstance_RVC_decoder__texture_V__idct2d__clip_constructor(AbstractActorInstance *);
...
ActorClass klass=INIT_ActorClass(
  ...
  ActorInstance_RVC_decoder__texture_V__idct2d__clip,
  ActorInstance_RVC_decoder__texture_V__idct2d__clip_constructor,
  0, //setParam not needed anymore (we instantiate with params)
  0, 0, // serialize/deserialize
  RVC_decoder__texture_V__idct2d__clip_action_scheduler,
  0, // no destructor
...
#define ActorInstance_RVC_decoder__texture_V__idct2d__clip__set_sign_ID 0
#define ActorInstance_RVC_decoder__texture_V__idct2d__clip__clip_ID 1
static void ActorInstance_RVC_decoder__texture_V__idct2d__clip_constructor(AbstractActorInstance *pBase) {
  ActorInstance_RVC_decoder__texture_V__idct2d__clip *thisActor=(ActorInstance_RVC_decoder__texture_V__idct2d__clip*) pBase;
  thisActor->_fsmState = ActorInstance_RVC_decoder__texture_V__idct2d__clip__set_sign_ID;//Initial state
  {
  }
...
ART_ACTION_SCHEDULER(RVC_decoder__texture_V__idct2d__clip_action_scheduler) {
  ...
  while(1) {
    switch(thisActor->_fsmState) {
      case ActorInstance_RVC_decoder__texture_V__idct2d__clip__set_sign_ID:
        if ((pinAvailIn_bool_t(IN1_SIGNED) >= 1)) {
          ART_FIRE_ACTION(action0__read_signed);
          thisActor->_fsmState = ActorInstance_RVC_decoder__texture_V__idct2d__clip__clip_ID;
          continue;
        }
      ...
      case ActorInstance_RVC_decoder__texture_V__idct2d__clip__clip_ID:
        if ((pinAvailIn_int32_t(IN0_I) >= 64)) {
          if ((pinAvailOut_int32_t(OUT0_O) >= 64)) {
            ART_FIRE_ACTION(action1__clip);
            thisActor->_fsmState = ActorInstance_RVC_decoder__texture_V__idct2d__clip__set_sign_ID;
            continue;
