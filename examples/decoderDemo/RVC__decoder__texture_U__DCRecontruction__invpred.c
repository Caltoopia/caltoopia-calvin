...
//Actor functions
static inline int32_t RVC_decoder__texture_U__DCRecontruction__invpredabs(ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred* thisActor, int32_t x){
  return (((x < 0)) ? ((-(x))):(x));
}
static inline int32_t RVC_decoder__texture_U__DCRecontruction__invpreddc_scaler(ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred* thisActor){
...
static inline int32_t RVC_decoder__texture_U__DCRecontruction__invpredsaturate(ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred* thisActor, int32_t x){
  bool_t minus;
  bool_t plus;
  int32_t ret;
  minus = (x < (-(2048)));
...
ART_ACTION(action0__start, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred);
ART_ACTION(action1__getw, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred);
ART_ACTION(action2__skip, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred);
ART_ACTION(action3__read__inter_ac, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred);
ART_ACTION(action4__read__other, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred);
ART_ACTION(action5__read__intra, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred);
ART_ACTION(action6__getdc__inter, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred);
ART_ACTION(action7__getdc__intra, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred);
ART_ACTION(action8__sat, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred);
ART_ACTION(action9__advance, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred);
ART_ACTION_SCHEDULER(RVC_decoder__texture_U__DCRecontruction__invpred_action_scheduler);
static void ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred_constructor(AbstractActorInstance *);
...
ActorClass klass=INIT_ActorClass(
  "RVC_decoder__texture_U__DCRecontruction__invpred",
  ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred,
...
bool_t RVC_decoder__texture_U__DCRecontruction__invpred__DOLLAR__d859(art_action_context_t *context, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred *thisActor) {
  int32_t cmd;
  {
    bool_t ret;
...
bool_t RVC_decoder__texture_U__DCRecontruction__invpred__DOLLAR__d888(art_action_context_t *context, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred *thisActor) {
  int32_t cmd;
  {
    bool_t ret;
    cmd = pinPeek_int32_t(IN0_BTYPE, 0);
...
bool_t RVC_decoder__texture_U__DCRecontruction__invpred__DOLLAR__d897(art_action_context_t *context, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred *thisActor) {
  int32_t cmd;
  {
    bool_t ret;
    cmd = pinPeek_int32_t(IN0_BTYPE, 0);
...
bool_t RVC_decoder__texture_U__DCRecontruction__invpred__DOLLAR__d944(art_action_context_t *context, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred *thisActor) {
  int32_t cmd;
  {
    bool_t ret;
    cmd = pinPeek_int32_t(IN0_BTYPE, 0);
...
ART_ACTION(action5__read__intra, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred) {
  ...
  horiz = RVC_decoder__texture_U__DCRecontruction__invpredabs(thisActor, (dcb - dcc));
  vert = RVC_decoder__texture_U__DCRecontruction__invpredabs(thisActor, (dca - dcb));
  top = (vert < horiz);
  thisActor->s_qp = qp;
  thisActor->s_prev_qp = thisActor->s_qp;
  thisActor->round = bitxor(bitand(thisActor->s_qp, 1), 1);
...
ART_ACTION(action6__getdc__inter, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred) {
  ...
  v = ((thisActor->s_qp * (lshift(RVC_decoder__texture_U__DCRecontruction__invpredabs(thisActor, dc), 1) + 1)) - thisActor->round);
...
ART_ACTION(action8__sat, ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred) {
  ...
  dc = RVC_decoder__texture_U__DCRecontruction__invpredsaturate(thisActor, thisActor->dc_val);
...
#define ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__read_ID 0
#define ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__getw_ID 1
#define ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__inter_ID 2
#define ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__intra_ID 3
#define ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__advance_ID 4
#define ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__geth_ID 5
#define ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__sat_ID 6
static void ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred_constructor(AbstractActorInstance *pBase) {
  ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred *thisActor=(ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred*) pBase;
  thisActor->_fsmState = ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__read_ID;//Initial state
  {
...
ART_ACTION_SCHEDULER(RVC_decoder__texture_U__DCRecontruction__invpred_action_scheduler) {
  ...
  while(1) {
    switch(thisActor->_fsmState) {
      case ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__read_ID:
        if ((pinAvailIn_int32_t(IN0_BTYPE) >= 1)) {
          if (RVC_decoder__texture_U__DCRecontruction__invpred__DOLLAR__d859(context, thisActor)) {
            if ((pinAvailOut_int32_t(OUT2_AC_PRED_DIR) >= 1)) {
              ART_FIRE_ACTION(action0__start);
              thisActor->_fsmState = ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__getw_ID;
              continue;
        ...
        if ((pinAvailIn_int32_t(IN0_BTYPE) >= 1) && (pinAvailIn_int32_t(IN5_QP) >= 1)) {
          if (RVC_decoder__texture_U__DCRecontruction__invpred__DOLLAR__d888(context, thisActor) && RVC_decoder__texture_U__DCRecontruction__invpred__DOLLAR__d897(context, thisActor)) {
            if ((pinAvailOut_int32_t(OUT2_AC_PRED_DIR) >= 1) && (pinAvailOut_int32_t(OUT1_PTR) >= 1) && (pinAvailOut_bool_t(OUT3_SIGNED) >= 1) && (pinAvailOut_int32_t(OUT4_QUANT) >= 1) && (pinAvailOut_int32_t(OUT5_PREV_QUANT) >= 1)) {
              ...
              thisActor->_fsmState = ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__inter_ID;
              continue;
        ...
        if ((pinAvailIn_int32_t(IN0_BTYPE) >= 1) && (pinAvailIn_int32_t(IN5_QP) >= 1)) {
          if (RVC_decoder__texture_U__DCRecontruction__invpred__DOLLAR__d944(context, thisActor)) {
            if ((pinAvailOut_int32_t(OUT2_AC_PRED_DIR) >= 1)) {
              ART_FIRE_ACTION(action4__read__other);
              thisActor->_fsmState = ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__advance_ID;
              continue;
        ...
        if ((pinAvailIn_int32_t(IN0_BTYPE) >= 1) && (pinAvailIn_int32_t(IN5_QP) >= 1) && (pinAvailIn_int32_t(IN1_A) >= 1) && (pinAvailIn_int32_t(IN2_B) >= 1) && (pinAvailIn_int32_t(IN3_C) >= 1)) {
          if ((pinAvailOut_int32_t(OUT1_PTR) >= 1) && (pinAvailOut_int32_t(OUT2_AC_PRED_DIR) >= 1) && (pinAvailOut_bool_t(OUT3_SIGNED) >= 1) && (pinAvailOut_int32_t(OUT4_QUANT) >= 1) && (pinAvailOut_int32_t(OUT5_PREV_QUANT) >= 1)) {
            ...
            thisActor->_fsmState = ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__intra_ID;
            continue;
      ...
      case ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__getw_ID:
        if ((pinAvailIn_int32_t(IN0_BTYPE) >= 1)) {
          ART_FIRE_ACTION(action1__getw);
          thisActor->_fsmState = ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__geth_ID;
          continue;
        }
        result = exitcode_block_Any;
        goto out;
      ...
      case ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__inter_ID:
        if ((pinAvailIn_int32_t(IN4_QFS_DC) >= 1)) {
          ART_FIRE_ACTION(action6__getdc__inter);
          thisActor->_fsmState = ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__sat_ID;
          continue;
        }
        result = exitcode_block_Any;
        goto out;
      ...
      case ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__intra_ID:
        if ((pinAvailIn_int32_t(IN4_QFS_DC) >= 1)) {
      ...
      case ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__advance_ID:
        ART_FIRE_ACTION(action9__advance);
        thisActor->_fsmState = ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__read_ID;
        continue;
        result = exitcode_block_Any;
        goto out;
        break;
      
      case ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__geth_ID:
        if ((pinAvailIn_int32_t(IN0_BTYPE) >= 1)) {
      ...
      case ActorInstance_RVC_decoder__texture_U__DCRecontruction__invpred__sat_ID:
