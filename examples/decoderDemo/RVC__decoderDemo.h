...
inline int32_t* Integers(int32_t start, int32_t stop);
...
inline int32_t lshift(int32_t x, int32_t y);
...
inline int32_t bitnot(int32_t x);
...
inline int32_t bitand(int32_t x, int32_t y);
...
inline int32_t bitxor(int32_t x, int32_t y);
extern int32_t decoder__motion_V__INTRA;
inline int32_t bitor(int32_t x, int32_t y);
...
inline int32_t urshift(int32_t x, int32_t y);
...
inline int32_t rshift(int32_t x, int32_t y);
